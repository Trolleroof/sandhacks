      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {features.map((feature) => (
            ...
            >
              <div className="inline-flex items-center justify-center w-12 h-12 rounded-[14px] bg-slateblue/20 mb-4">
                <feature.icon className="h-6 w-6 text-denim" />
              </div>
              <h3 className="text-lg font-semibold text-eggshell mb-2">
                {feature.title}
              </h3>
