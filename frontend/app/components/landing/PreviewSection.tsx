          ...
          <div className="rounded-[24px] border border-slateblue/40 bg-ink overflow-hidden shadow-2xl">
            ...
            <div className="p-6 grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              <div className="aspect-video bg-gradient-to-br from-space to-ink rounded-[18px] border border-slateblue/30 flex items-center justify-center relative overflow-hidden">
                ...
                {/* Detection box */}
                <div className="absolute top-1/4 left-1/3 w-24 h-24 border-2 border-denim rounded-lg flex items-end justify-center pb-1">
                ...
                {/* Status */}
                <div className="absolute bottom-4 left-4 flex items-center gap-2 bg-ink/80 backdrop-blur-sm rounded-[10px] px-3 py-1.5">
